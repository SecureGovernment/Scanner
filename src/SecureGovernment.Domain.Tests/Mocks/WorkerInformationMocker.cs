...
namespace SecureGovernment.Domain.Tests.Mocks
{
    ...
    {
        public static WorkerInformation MockWorkerInformation(string hostname = "", X509Certificate2 certificate = null, X509Certificate2 issuer = null, Chain chain = null)
        {
